...
func (h *handler) Register(router *mux.Router) {
	...
	router.HandleFunc("/providers-service/{iata}/delete_airline", h.DeleteAirlineByCode).Methods("GET", "DELETE")

	router.HandleFunc("/providers-service/add_provider", h.AddProvider).Methods("POST")

	router.HandleFunc("/providers-service/{provider_id}/delete_provider", h.DeleteProviderById).Methods("DELETE")
	...
	router.HandleFunc("/providers-service/find_schema", h.FindSchemaByName).Methods("GET")

	router.HandleFunc("/providers-service/update_schema", h.UpdateSchema).Methods("PUT")

	router.HandleFunc("/providers-service/{id}/delete_schema", h.SaveDeleteSchema).Methods("DELETE")
	...
	router.HandleFunc("/providers-service/{id}/delete_account", h.DeleteAccountById).Methods("DELETE")
